...
<div class="container">
                ...
                <tbody>
                    @foreach ($cart_items as $c)
                        <tr>
                            ...
                            <td>{{$c['code']}}</td>
                            <td>{{$c['name']}}</td>
                            <td><input type="text" class="form-control" value="{{$c['qty']}}" OnKeyUp="updateCart({{$c['id']}},this)" style="width: 90px;">
    ...
    <div class="pull-right">
        ...
        class="btn btn-primary">ชำระเงิน<i class="fa fa-chevron-right"></i></a>
    </div>
</div>
    <script> function updateCart(id,qty){
